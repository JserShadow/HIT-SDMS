...
module.exports = app => {
  ...
  router.get('/admin/remark/getAllRemarks', controller.admin.getAllRemarks);
  router.post('/admin/remark/pass', controller.admin.remarkPass);
  router.post('/admin/remark/fail', controller.admin.remarkFail);
